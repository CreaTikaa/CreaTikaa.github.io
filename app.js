$(document).ready(function() {
    function loadMovies(niveau, noteMin, noteMax, origineFilm) {
        ...
        $.ajax({
            url: 'https://webeval2-f74cb9kia-creas-projects-b97f3d41.vercel.app/movies',
            type: 'GET',
            dataType: 'json',
            data: data,
    ...
    function deleteMovie(id, instance) {
        $.ajax({
            url: `https://webeval2-f74cb9kia-creas-projects-b97f3d41.vercel.app/movies/${id}`,
            type: 'DELETE',
    ...
    $('#edit-form').submit(function (event) {
        ...
        $.ajax({
            url: `https://webeval2-f74cb9kia-creas-projects-b97f3d41.vercel.app/movies/${movieId}`,
            type: 'PUT',
